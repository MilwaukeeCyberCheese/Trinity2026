...
import edu.msoe.cybercheese.trinity.subsystems.drive.Drive;
    ...
    public static Command joystickDrive(
        ...
        return Commands.run(
                () -> {
                    ...
                    //          Rotation2d driveRotation = isFlipped
                    //                  ? drive.getRotation().plus(new Rotation2d(Math.PI))
                    //                  : drive.getRotation();
                    Rotation2d driveRotation = Rotation2d.kZero;
                    drive.runVelocity(ChassisSpeeds.fromFieldRelativeSpeeds(speeds, driveRotation));
                },
                drive);
    }
